...
const RegisterForm = () => {
    ...
    return (
        ...
        {/* Header */}
        <h1 className="text-3xl text-center font-bold text-[#5AD3AF] dark:text-[#5AD3AF] mb-6">
            Create an Account
        </h1>
        ...
        <div className="flex justify-center mt-4">
            <Button
                ...
                className="w-full max-w-sm bg-[#657ED4] hover:bg-[#485b99] dark:bg-gray-700 dark:hover:bg-gray-600 text-white rounded-lg py-2 flex items-center justify-center gap-2"
