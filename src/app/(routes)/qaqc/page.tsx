    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-2xl font-bold">120<span className="text-base font-normal">h</span> 56<span className="text-base font-normal">m</span></p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-2xl font-bold">$12.080 <span className="text-sm font-normal text-gray-400">/ March</span></p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-2xl font-bold">82% <span className="text-sm font-normal text-gray-400">89h 24m left</span></p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader className="flex flex-row justify-between items-center">
          ...
          <Button variant="link" className="text-sm">See tracker</Button>
        </CardHeader>
        <CardContent>
