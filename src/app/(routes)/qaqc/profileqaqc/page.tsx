...
export default function ProfileQaQc() {
            ...
            {loading ? (
                ...
                <div className="flex flex-col items-center justify-center min-h-[50vh] bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 max-w-md w-full">
                    ...
                    <button
                        ...
                        className="mt-6 px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-400 transition-colors"
                    >
                        Retry
                    </button>
                </div>
                    ...
                    <div className="text-center mb-8">
                        <div className="flex justify-center mb-4">
                            <div className="relative">
                                ...
                                <span className="absolute -top-2 -right-2 bg-indigo-600 dark:bg-indigo-500 text-white text-xs font-bold rounded-full h-6 w-6 flex items-center justify-center">
                                    M
                                </span>
                            </div>
                        </div>
