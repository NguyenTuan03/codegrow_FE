...
// import { Badge } from '@/components/ui/badge';
// import { toast } from '@/components/ui/use-toast';
// import { Loader2, Eye, Edit, Save, CheckCircle, ArrowLeft, PlayCircle, FileText } from 'lucide-react';
// import { viewDetailLesson } from '@/lib/services/lessons/getdetailllesson';
// import { UpdateLesson } from '@/lib/services/lessons/updateLessonFeedback';
...
//                       className={
//                         lesson.status === 'done'
//                           ? 'bg-[#5AD3AF]/10 text-[#5AD3AF] dark:bg-[#5AD3AF]/20 dark:text-[#5AD3AF]'
...
//                   onClick={() => router.push(`/qaqc/courses/${courseId}`)}
//                   variant="outline"
//                   className="w-full sm:w-auto text-[#657ED4] border-[#657ED4] hover:bg-[#657ED4] hover:text-white dark:text-[#657ED4] dark:border-[#657ED4] dark:hover:bg-[#657ED4] dark:hover:text-white rounded-lg px-6 py-2"
//                 >
//                   <ArrowLeft className="h-4 w-4 mr-2" />
//                   Back to Lessons
//                 </Button>
//                 <Dialog open={isUpdateLessonDialogOpen} onOpenChange={setIsUpdateLessonDialogOpen}>
//                   <DialogTrigger asChild>
//                     <Button className="w-full sm:w-auto bg-[#5AD3AF] hover:bg-[#4ac2a0] text-white rounded-lg px-6 py-2">
//                       <Edit className="h-4 w-4 mr-2" />
//                       Update Lesson
//                     </Button>
//                   </DialogTrigger>
...
//                         <Select
//                           value={updateLessonData.status}
//                           onValueChange={(value) => handleUpdateLessonInputChange('status', value)}
//                         >
//                           <SelectTrigger className="w-full bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 focus:ring-[#5AD3AF] rounded-lg">
//                             <SelectValue placeholder="Select status" />
//                           </SelectTrigger>
//                           <SelectContent className="bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-700">
...
//                         <Select
//                           value={updateLessonData.mark}
//                           onValueChange={(value) => handleUpdateLessonInputChange('mark', value)}
//                         >
//                           <SelectTrigger className="w-full bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 focus:ring-[#5AD3AF] rounded-lg">
//                             <SelectValue placeholder="Select mark" />
//                           </SelectTrigger>
...
//                         <Textarea
//                           value={updateLessonData.note}
//                           onChange={(e) => handleUpdateLessonInputChange('note', e.target.value)}
//                           placeholder="Add your notes here..."
//                           className="min-h-[100px] bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 focus:ring-[#5AD3AF] rounded-lg"
//                         />
//                       </div>
//                       <Button
//                         onClick={handleUpdateLesson}
//                         className="w-full bg-[#5AD3AF] hover:bg-[#4ac2a0] text-white rounded-lg"
//                       >
//                         <Save className="h-4 w-4 mr-2" />
//                         Save Changes
//                       </Button>
...
//                       Reading Material
//                     </Label>
//                     <Card className="bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 rounded-lg p-4 space-y-4">
//                       <div className="space-y-2">
...
//                     <p className="text-gray-500 dark:text-gray-400 italic">
//                       No video or reading material available
//                     </p>
//                   </Card>
//                 )}
//               </div>
...
//                           }
//                         >
//                           {quiz.type === 'multiple_choice' ? 'Multiple Choice' : 'Coding'}
//                         </Badge>
//                       </div>
//                     </CardHeader>
//                     <CardContent className="p-4 space-y-2">
...
//                       {quiz.type === 'multiple_choice' ? (
//                         <div className="text-xs text-gray-500 dark:text-gray-400">
//                           <span>{quiz.options?.filter((o) => o.isCorrect).length} correct option(s)</span>
//                         </div>
//                       ) : (
//                         <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
//                           <span>{quiz.language || 'N/A'}</span>
//                           <span>• {quiz.testCases?.length || 0} test case(s)</span>
//                         </div>
//                       )}
//                     </CardContent>
//                     <div className="p-4">
...
//                               }`}
//                             >
//                               {option.isCorrect && <CheckCircle className="h-3 w-3" />}
//                             </div>
