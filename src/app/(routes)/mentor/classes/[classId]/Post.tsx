    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300">
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-8 transition-all duration-300">
                <textarea
                    className="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5AD3AF] dark:focus:ring-[#5AD3AF] bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 resize-y text-base"
                    rows={5}
                ...
                <div className="mt-4 flex items-center justify-between">
                    <label className="flex items-center space-x-2 text-gray-600 dark:text-gray-300 cursor-pointer hover:text-[#5AD3AF] dark:hover:text-[#5AD3AF] transition-colors duration-200">
                ...
                <div className="mt-6 flex justify-end space-x-3">
                    <button
                        className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 flex items-center space-x-2 transition-colors duration-200 disabled:opacity-50 text-sm font-medium"
                    ...
                    <button
                        className="px-4 py-2 bg-[#5AD3AF] text-white rounded-lg hover:bg-[#4ac2a0] flex items-center space-x-2 transition-colors duration-200 disabled:opacity-50 text-sm font-medium"
