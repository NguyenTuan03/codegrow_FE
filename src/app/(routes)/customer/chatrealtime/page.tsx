    ...
    const messages: Message[] = [
        {
            ...
            username: 'Mentor',
            avatar: '/mentor.png',
            body: 'Chào bạn! Mình có thể giúp gì cho bạn trong việc đăng ký trở thành mentor?',
            likes: 0,
            createdAt: '2025-05-18T15:46:00+07:00',
        },
        {
            id: '2',
            username: 'User',
            body: 'Mình muốn đăng ký làm mentor. Các bước thực hiện như thế nào ạ?',
            likes: 0,
            createdAt: '2025-05-18T15:47:00+07:00',
        },
        {
            id: '3',
            username: 'Mentor',
            avatar: '/mentor.png',
            body: 'Đầu tiên, bạn cần điền thông tin cá nhân và kinh nghiệm giảng dạy. Sau đó, mình sẽ hướng dẫn bạn qua các bước tiếp theo nhé!',
            likes: 0,
            createdAt: '2025-05-18T15:48:00+07:00',
        },
    ];

    // Placeholder for input state (for UI purposes)
        ...
        <div className="flex flex-col h-96 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-[#5AD3AF] to-[#4ac2a0] p-4 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-white">Chat với Mentor</h3>
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                <div className="flex items-center gap-3">
                    ...
                    />
                    <Button className="rounded-full bg-[#5AD3AF] hover:bg-[#4ac2a0] text-white p-3 transition-all duration-300 shadow-md">
                        <svg
