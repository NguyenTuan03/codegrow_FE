...
export default function CourseHeader({ course }: CourseHeaderProps) {
    ...
    }, [userAuth]); // Add userAuth as a dependency to re-run when userAuth changes
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h1 className="text-3xl font-bold text-[#657ED4] dark:text-[#5AD3AF] mb-2">
                ...
                <div className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                    <p>
                        Học phí: <span className="font-semibold">{course.price}</span>
                    </p>
                </div>
                {enrolledCourses
                    .map((enrolledCourse) => enrolledCourse._id)
                    .includes(course._id) ? (
                    <div className="text-lg text-green-500 font-semibold mb-4">
