        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-[#EEF1EF] dark:border-[#657ED4]/30">
            ...
            <div className="space-y-6">
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    <h4 className="font-medium text-xl text-gray-800 dark:text-gray-200 mb-3">
                        Tổng quan điểm số
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="bg-purple-50 dark:bg-purple-900 p-3 rounded-lg">
                            <p className="text-base text-gray-600 dark:text-gray-400">Xếp hạng</p>
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead className="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    <th className="px-6 py-3 text-left text-base font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                        Bài học
                                    </th>
                                    <th className="px-6 py-3 text-left text-base font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                        Loại
                            ...
                            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <tr>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className="px-2 inline-flex text-base leading-5 font-semibold rounded-full bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-400">
                                            Hoàn thành
                                        </span>
                                    </td>
                                </tr>
