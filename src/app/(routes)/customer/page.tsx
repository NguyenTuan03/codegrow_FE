    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-12 gap-4 mb-10">
        <div className="col-span-8">
          ...
          <p className='mb-2'>Solve coding exercises and get mentored to develop fluency in your chosen programming languages.</p>
          ...
          {HOME_INTRODUCTION.map((item, index) => (
            <Card key={index} className="col-span-12 md:col-span-6 lg:col-span-3 shadow-md">
      ...
      <Card>
        <CardHeader>
          <CardTitle className='text-3xl text-center my-3'>All courses in CODEGROW</CardTitle>          
        </CardHeader>
        <CardContent>
                ...
                COURSES.map((item,index) => {
                  return (
                    <Card key={index} className='col-span-4'>
                        <CardHeader>
                          <Image src={item.img} alt='Course' width={420} height={200}/>
                        </CardHeader>
                        <CardContent>
                        ...
                        <CardFooter className='flex flex-row items-center justify-between'>
                          <div className='flex flex-row items-center gap-2'>
                            <Image src={item.learnerIcon} width={30} height={30} alt=''/>
                            {item.learners}
                          </div>
                          <div className='flex flex-row items-center gap-2'>
                            <Image src={item.learnerIcon} width={30} height={30} alt=''/>
        ...
        <CardFooter className='flex justify-center'>
          <Button className='text-center p-3 bg-[#5AD3AF] text-white text-xl'>View all courses</Button>
        </CardFooter>
      </Card>
      <div>
        ...
        {['1', '2', '3', '4'].map((_, index) => (
          ...
          >
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              The learning path is designed methodically, in detail, and in accordance with learning goals.
              A good roadmap will help make learning effective, not wasteful, not going down the wrong path,
              and wherever you learn, it will be useful.
            </p>
          </div>
        ))}
        </div>
