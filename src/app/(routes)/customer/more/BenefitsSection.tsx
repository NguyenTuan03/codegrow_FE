    ...
    const benefits = [
        {
            ...
            icon: <Award className="w-12 h-12 text-[#5AD3AF] mx-auto" />,
        },
        {
            title: 'Job-Ready Skills',
            desc: 'Gain practical skills employers value',
            icon: <Rocket className="w-12 h-12 text-[#5AD3AF] mx-auto" />,
        },
        {
            title: 'Lifetime Access',
            desc: 'Revisit course materials anytime',
            icon: <Globe className="w-12 h-12 text-[#5AD3AF] mx-auto" />,
        },
        {
            title: 'Career Support',
            desc: 'Resume building & job recommendations',
            icon: <Briefcase className="w-12 h-12 text-[#5AD3AF] mx-auto" />,
        },
    ];

    return (
        <div>
            <h2 className="text-3xl font-bold text-center mb-12 text-[#657ED4] dark:text-[#5AD3AF]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {benefits.map((item, idx) => (
                    ...
                    >
                        <CardHeader>
                            {item.icon}
                            <CardTitle className="text-lg font-semibold mt-4 text-[#657ED4] dark:text-[#5AD3AF]">
                                {item.title}
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
