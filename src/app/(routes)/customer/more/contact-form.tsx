                                ...
                                <FormControl>
                                    <div className="relative">
                                        <select
                                            ...
                                            disabled={isSubmitting}
                                            className="mt-1 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-[#657ED4] dark:focus:ring-[#5AD3AF] focus:border-[#657ED4] dark:focus:border-[#5AD3AF] bg-white dark:bg-gray-700 text-gray-400 dark:text-gray-100 rounded-lg cursor-text w-full pl-3 pr-10 py-2 appearance-none transition-all duration-200"
