...
export default function Classes() {
    ...
    const handleViewDetails = (classId: string) => {
        console.log('Navigating to class details for ID:', classId);
        router.push(`/customer/classes/${classId}`);
    };

    return (
        <div className="p-10 mx-auto py-8 bg-white dark:bg-gray-900">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Class List</h1>
            </div>
