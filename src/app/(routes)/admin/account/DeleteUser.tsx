    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <Card className="w-[400px] bg-white dark:bg-gray-800 dark:text-white relative z-10 pointer-events-auto rounded-lg shadow-lg">
                <CardHeader>
                    <CardTitle className="text-xl font-bold text-red-600 dark:text-red-400 cursor-default">
                        Delete Account
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="flex justify-end gap-2 mt-6">
                        ...
                        <Button
                            className="bg-red-500 dark:bg-red-700 text-white hover:bg-red-600 dark:hover:bg-red-600 cursor-pointer"
                            onClick={onDelete}
                        >
                            Delete
                        </Button>
